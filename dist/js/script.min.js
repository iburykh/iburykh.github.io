...
var smoothScroll = function smoothScroll() {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      event.preventDefault(); // let widthTop = document.documentElement.scrollTop;

      var hash = this.getAttribute('href').replace('#', ''); // let toBlock = document.querySelector('.' + hash).getBoundingClientRect().top;

      var toBlock = document.querySelector('.' + hash); // let start = null;

      zenscroll.to(toBlock); // zenscroll.to(about, 500); // 500ms == half a second

...
/* harmony import */ var _modules_slider_auto__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/slider_auto */ "./src/js/modules/slider_auto.js");
/* harmony import */ var _modules_show_more__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/show_more */ "./src/js/modules/show_more.js");
/* harmony import */ var _modules_upload__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/upload */ "./src/js/modules/upload.js");
/* harmony import */ var _modules_form_calc__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/form_calc */ "./src/js/modules/form_calc.js");
...
/* harmony import */ var _modules_picture_size__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/picture_size */ "./src/js/modules/picture_size.js");
/* harmony import */ var _modules_spoilers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/spoilers */ "./src/js/modules/spoilers.js");
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/form */ "./src/js/modules/form.js");
/* harmony import */ var _modules_popup__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/popup */ "./src/js/modules/popup.js");
/* harmony import */ var _modules_mask_tel__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/mask_tel */ "./src/js/modules/mask_tel.js");
/* harmony import */ var _modules_check_inputs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/check_inputs */ "./src/js/modules/check_inputs.js");
/* harmony import */ var _modules_scroll__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/scroll */ "./src/js/modules/scroll.js");
/* harmony import */ var _modules_lazy__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/lazy */ "./src/js/modules/lazy.js");
...
Object(_modules_burger__WEBPACK_IMPORTED_MODULE_3__["default"])('.menu', '.menu__sublink', '.hamburger', true);
Object(_modules_slider_auto__WEBPACK_IMPORTED_MODULE_4__["default"])();
Object(_modules_show_more__WEBPACK_IMPORTED_MODULE_5__["default"])();
Object(_modules_upload__WEBPACK_IMPORTED_MODULE_6__["default"])();
Object(_modules_form_calc__WEBPACK_IMPORTED_MODULE_7__["default"])();
Object(_modules_filter__WEBPACK_IMPORTED_MODULE_8__["default"])();
Object(_modules_picture_size__WEBPACK_IMPORTED_MODULE_9__["default"])();
Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])();
Object(_modules_spoilers__WEBPACK_IMPORTED_MODULE_10__["default"])();
Object(_modules_form__WEBPACK_IMPORTED_MODULE_11__["default"])();
Object(_modules_popup__WEBPACK_IMPORTED_MODULE_12__["default"])();
Object(_modules_mask_tel__WEBPACK_IMPORTED_MODULE_13__["default"])();
Object(_modules_check_inputs__WEBPACK_IMPORTED_MODULE_14__["default"])();
Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_15__["default"])();
Object(_modules_lazy__WEBPACK_IMPORTED_MODULE_16__["default"])();
window.noZensmooth = true; //Up arrow
...
var menuBurger = function menuBurger() {
  ...
  var menuItem = document.querySelectorAll('.menu__sublink');
  ...
  menuItem.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      var menuList = document.querySelectorAll('.menu__sublist');
...
/***/ "./src/js/modules/check_inputs.js":
/*!****************************************!*\
  !*** ./src/js/modules/check_inputs.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var checkTextInputs = function checkTextInputs() {
  var textInputs = document.querySelectorAll('.check');
...
var filter = function filter() {
  var menu = document.querySelector('.portfolio__menu'),
  ...
  var clickMenu = function clickMenu(selector) {
...
var form = function form() {
  ...
  var clearInputs = function clearInputs(inputs, file) {
  ...
  if (forms.length > 0) {
    forms.forEach(function (item) {
      item.addEventListener('submit', function (e) {
        ...
        var fileName = target.querySelector('.file__name');
        var formReq = item.querySelectorAll('.req');
        formRemoveError(formReq);
        var error = formValidate(formReq);

        if (error === 0) {
          var textMessage = item.parentElement.querySelector('.form-message');
          ...
          var formData = new FormData(item); //! УБРАТЬ
          ...
          var newfile = formData.get('upload');
  ...
  function formAddError(item) {
    ...
    var formError = item.parentElement.querySelector('.form-message');
  ...
  function formRemoveError(selector) {
    if (selector.length > 0) {
      for (var index = 0; index < selector.length; index++) {
        ...
        var formError = input.parentElement.querySelector('.form-message');
...
var formCalc = function formCalc() {
  ...
  var formText = form.querySelector('.form-calc__price');
  var promocodeBlock = form.querySelector('.form-calc__promocode');
  var fileName = form.querySelector('.file__name');
  var fileInput = form.querySelector('[name="upload"]');
  var select = document.querySelectorAll('.select');
  var selectHeader = document.querySelectorAll('.select__header');
  var selectItem = document.querySelectorAll('.select__option');
  var selectBody = document.querySelectorAll('.select__body');
  var sizeBlock = document.querySelector('[name="size"]');
  var materialBlock = document.querySelector('[name="material"]');
  var optionsBlock = document.querySelector('[name="options"]'); //============== Select ===================================

  var _loop = function _loop(index) {
    var item = selectHeader[index];
  ...
  for (var index = 0; index < selectHeader.length; index++) {
    _loop(index);
  }
  ...
  selectItem.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      var selectActive = target.closest('.select');
      var header = selectActive.querySelector('.select__header');
      var input = selectActive.querySelector('.select__input');
      selectItem.forEach(function (item) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      ...
      formText.textContent = "".concat(Math.round(sum * 0.7), " \u0440\u0443\u0431.");
    } else {
      formText.textContent = "".concat(sum, " \u0440\u0443\u0431.");
      ;
    }
  };

  promocodeBlock.addEventListener('input', calcFunc); //==============Сообщения о ходе отправки==================
  ...
  form.addEventListener('submit', function (e) {
    ...
    if (error === 0) {
      formText.textContent = message.loading; //=========FormData=====================================
  ...
  window.addEventListener("scroll", function () {
    ...
    if (lazyImages.length > 0) {
      lazyImages.forEach(function (img) {
        var imgOffset = img.getBoundingClientRect().top + pageYOffset;

        if (scrollY >= imgOffset - 500) {
          if (img.dataset.src) {
            img.src = img.dataset.src;
            img.removeAttribute('data-src');
          } else if (img.dataset.srcset) {
            img.srcset = lazyImages[imgIndex].dataset.srcset;
...
var menu = function menu() {
  var menuBtn = document.querySelectorAll('.menu__link');

  var _loop = function _loop(index) {
    var item = menuBtn[index];
  ...
  for (var index = 0; index < menuBtn.length; index++) {
    _loop(index);
  }
...
/***/ "./src/js/modules/picture_size.js":
/*!****************************************!*\
  !*** ./src/js/modules/picture_size.js ***!
  \****************************************/
/*! exports provided: default */
...
var pictureSize = function pictureSize() {
  var blocks = document.querySelectorAll('.sizes__item');

  function showImg(block) {
    var img = block.querySelector('img');
    img.src = img.src.slice(0, -4) + '-1.png';
    block.querySelectorAll('div').forEach(function (p) {
...
var popup = function popup() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (smallFix.length > 0) {
          smallFix.forEach(function (item) {
    ...
    tabLast.addEventListener('keydown', function (e) {
...
var smoothScroll = function smoothScroll() {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var toBlock = document.querySelector('.' + hash);
      zenscroll.to(toBlock); // zenscroll.to(about, 500); // 500ms == время прокрутки
    });
  });
};
...
var showMore = function showMore() {
  var btn = document.querySelector('.style__btn');
  var wrapper = document.querySelector('.style__hidden');
  btn.addEventListener('click', function () {
...
var slider = function slider() {
  ...
  var btnActive = slidActive.querySelector('.slider-item__btn');
  var prev = document.querySelector('.feedback__prev');
  var next = document.querySelector('.feedback__next');
  btnActive.setAttribute('tabindex', '0');

  var tabBtn = function tabBtn() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var sliderAuto = function sliderAuto() {
  var slideIndex = 1;
  var paused = false;
  var items = document.querySelectorAll('.promo__img');
...
/* harmony default export */ __webpack_exports__["default"] = (sliderAuto);

/***/ }),

/***/ "./src/js/modules/spoilers.js":
/*!************************************!*\
  !*** ./src/js/modules/spoilers.js ***!
  \************************************/
/*! exports provided: default */
...
var spoilers = function spoilers() {
  var btns = document.querySelectorAll('.spoiler__btn');
  btns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var spollersBlock = this.closest('.spoilers');
      ...
      if (!spollersBlock.querySelectorAll('.slide').length) {
        if (oneSpoller && !this.classList.contains('active')) {
          var spollerActive = spollersBlock.querySelector('.spoiler__btn.active');
...
/* harmony default export */ __webpack_exports__["default"] = (spoilers);
...
var upload = function upload() {
  ...
  var fileName = document.querySelectorAll('.file__name');

  var _loop = function _loop(index) {
    var input = fileInputs[index];

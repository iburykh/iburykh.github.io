...
Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_15__["default"])(); //Up arrow
...
var menu = function menu() {
  ...
  if (isMobile.any()) {
    ...
    for (var _index = 0; _index < menuBtn.length; _index++) {
      _loop2(_index);
    }
  }
...
var smoothScroll = function smoothScroll() {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var toBlock = document.querySelector('.' + hash).getBoundingClientRect().top; // const blocklockValue = toBlock + pageYOffset - document.querySelector('header').offsetHeight;

      var start = null; // window.scrollTo({
      // 	top: blocklockValue,
      // 	behavior: "smooth"
      // });
